...
int _return(globalTS *global_table, string *id){
	...
	string *LastVar = ReadNameVar(prom->data->LInstr); // funkce na cteni nazvu posledni instrukce
...
int _for(globalTS *global_table, string *id){
    ...
    string *LastVar = ReadNameVar(global_table.data->LInstr);
    ...
    LtableInsert(global_table.data->LTable, &Label_2, TOK_STRING);
...
int _if(globalTS *global_table, string *id){
    ...
    string *LastVar = ReadNameVar(global_table->data->LInstr); // funkce na cteni nazvu posledni instrukce 
